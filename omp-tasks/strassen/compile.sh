...
clang -fopenmp -DWITH_OTTER -c -I../..//common ${OPT}   -I. -o main.o ../..//common/bots_main.c -DCDATE="\"2023/11/14;09:56\"" -DCC="\"clang -fopenmp\"" -DLD="\"clang -fopenmp\"" -DCMESSAGE="\"\"" -DLDFLAGS="\"${OPT}   \"" -DCFLAGS="\"-c -I../..//common ${OPT}   -I.\""
clang -fopenmp -DWITH_OTTER -c -I../..//common ${OPT}   -o strassen.o strassen.c
clang -fopenmp -DWITH_OTTER -c -I../..//common ${OPT}   -o ../..//common/bots_common.o ../..//common/bots_common.c
clang -fopenmp ${OPT}   -o ../..//bin/strassen.clang.omp-tasks main.o strassen.o  ../..//common/bots_common.o -lotter-task-graph -lotf2 -lm -lstdc++
...
clang -fopenmp -DWITH_OTTER -c -I../..//common ${OPT}   -DFORCE_TIED_TASKS -I. -o main-tied.o ../..//common/bots_main.c -DCDATE="\"2023/11/14;09:56\"" -DCC="\"clang -fopenmp\"" -DLD="\"clang -fopenmp\"" -DCMESSAGE="\"\"" -DLDFLAGS="\"${OPT}   \"" -DCFLAGS="\"-c -I../..//common ${OPT}   -DFORCE_TIED_TASKS -I.\""
cat strassen.c | sed -e "s/task \{1,\}untied/task/g" > tied-strassen.c ;\
clang -fopenmp -DWITH_OTTER -c -I../..//common ${OPT}   -DFORCE_TIED_TASKS -o strassen-tied.o tied-strassen.c;\
rm tied-strassen.c
clang -fopenmp -DWITH_OTTER ${OPT}   -o ../..//bin/strassen.clang.omp-tasks-tied main-tied.o strassen-tied.o  ../..//common/bots_common.o -lotter-task-graph -lotf2 -lm -lstdc++
