...
clang -fopenmp -DWITH_OTTER -c -I../..//common -O3   -DFORCE_TIED_TASKS -I. -o main-tied.o ../..//common/bots_main.c -DCDATE="\"2023/11/14;09:56\"" -DCC="\"clang -fopenmp\"" -DLD="\"clang -fopenmp\"" -DCMESSAGE="\"\"" -DLDFLAGS="\"-O3   \"" -DCFLAGS="\"-c -I../..//common -O3   -DFORCE_TIED_TASKS -I.\""
cat strassen.c | sed -e "s/task \{1,\}untied/task/g" > tied-strassen.c ;\
clang -fopenmp -DWITH_OTTER -c -I../..//common -O3   -DFORCE_TIED_TASKS -o strassen-tied.o tied-strassen.c;\
rm tied-strassen.c
clang -fopenmp -DWITH_OTTER -O3   -o ../..//bin/strassen.clang.omp-tasks-tied main-tied.o strassen-tied.o  ../..//common/bots_common.o -lotter-task-graph -lotf2 -lm -lstdc++
